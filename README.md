...
#### Nota
Independentemente de quererem apenas esclarecer algo acerca de um algoritmo, leiam primeiro a Introdução. Poderá conter informações importantes para vocês.\
